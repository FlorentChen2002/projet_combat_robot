...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.TeamAMainBotChenFallavierTang"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.TeamASecondaryBotChenFallavierTang"; //class given by name; is supposed to extends robotsimulator.Brain
